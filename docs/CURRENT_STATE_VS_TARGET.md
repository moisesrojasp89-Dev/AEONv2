...
| **Fase 6E** | **Pasarela Stripe & Webhooks Idempotentes** | 🎯 **EN PROGRESO / PRÓXIMO SPRINT** | Pasarela de pagos Stripe Checkout, webhooks idempotentes, gestión de suscripciones en `public.subscriptions` y portal de facturación en perfil. |
