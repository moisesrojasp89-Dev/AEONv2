...
| **Fase 6** | **AEON Pro Terminal & Monetización In-App** | 🎯 **EN PROGRESO / PRÓXIMO SPRINT** | Pasarela de pagos Stripe, webhooks idempotentes, gestión de suscripciones en `public.subscriptions` y desbloqueo de módulos Pro in-app (Chatbot IA, Señales Pro, Terminal de Mercados y Order Flow). |
